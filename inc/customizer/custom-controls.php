 ...
 */
class Travel_Master_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Travel_Master_Dropdown_Category_Control extends WP_Customize_Control {
...
class Travel_Master_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Travel_Master_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="travel-master-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Travel_Master_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Travel_Master_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="travel-master-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'travel-master' ); ?>" class="travel-master-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
Class Travel_Master_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
